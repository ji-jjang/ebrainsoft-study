...
public final class HttpConst {
  ...
  public static final String HTTP_REQUEST_LINE_METHOD = "method";
  public static final String HTTP_REQUEST_LINE_REQUEST_URI = "requestURI";
  public static final String HTTP_REQUEST_LINE_PROTOCOL = "protocol";
